...
class DummySurface(BaseQuadrilateralSurface):
    ...
    def get_strike(self):
        p1 = Point(*self.coordinates_list[0][0])
        p2 = Point(*self.coordinates_list[0][-1])
...
class GetRXDistanceTestCase(unittest.TestCase):
    ...
    def test9_non_planar_surface_case1(self):
        ...
        # distances are tested on 4 point. The first two are on the hanging-
    ...
    def test11_non_planar_surface_case3(self):
        ...
        # distances are tested on 4 point. The first two are on the foot-
